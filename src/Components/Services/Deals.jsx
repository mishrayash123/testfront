...
<div className='my-3'>
      ...
      <CardBody placeholder="k">
        ...
        <Typography color="gray" className='line-through text-red-600 font-bold text-sm' placeholder="k">
          {parseInt(products.price+50)}
        </Typography>
        <Typography color="gray" className=' text-black font-bold text-sm' placeholder="k">
          {products.price} &#8377;
        </Typography>
        </div>
        <Typography
      ...
      <CardBody placeholder="k">
        ...
        <div className='flex items-center justify-between'>
        <p className=' text-red-600 font-bold text-sm' placeholder="k">
          Deal Of the day
        </p>
        </div>
        {/* <div className="group mt-8 inline-flex flex-wrap items-center gap-3">
